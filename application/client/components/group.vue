...
<table style="width: 500px">
    ...
    <tr>
        <td class="panel">
			...
			<br />
			Subjects:<br />
			<span v-for="(item, index) in group.subjects" :key="index">
			...
			<ul>
				...
				<button v-on:click="deleteGroup(group.name)"><img src="cross.png"/></button></li>
			</ul><br />
			<br />
    ...
    export default {
        ...
        methods: {
			...
			deleteGroup(name) {
				let request = {
                    "method": "DELETE",
                    "url": process.env.VUE_APP_BASE_URL + "/api/groups?name=" + name,
                    "headers": {
                        "content-type": "application/json"
                    }
                };
